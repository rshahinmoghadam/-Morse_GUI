...
class window(QWidget):
	def __init__(self):
		...
		label = QLabel("Only Capital letters allowed!",self)
		label.move(50,10)
	...
	def func(self):
		...
		QMessageBox.question(self,'Message', "Fnished ",QMessageBox.Ok, QMessageBox.Ok)
